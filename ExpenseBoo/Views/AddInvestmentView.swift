                        ...
                        VStack(alignment: .leading, spacing: 8) {
                            ...
                            HStack {
                                ...
                                DatePicker("", selection: $selectedDate, displayedComponents: [.date, .hourAndMinute])
                                    .labelsHidden()
                                    .accentColor(AppTheme.Colors.investment)
                                Spacer()
                            }
                            .padding()
                            .background(Color.white.opacity(0.05))
                    ...
                    HStack(spacing: 16) {
                        ...
                        Button(action: { saveInvestment() }) {
                            Text("Save Investment")
                                ...
                                .background(
                                    LinearGradient(
                                        colors: [AppTheme.Colors.investment, AppTheme.Colors.investment.opacity(0.8)],
                                        startPoint: .topLeading,
                                        endPoint: .bottomTrailing
                                    )
                                )
                                .cornerRadius(28)
                                .shadow(color: AppTheme.Colors.investment.opacity(0.4), radius: 10, x: 0, y: 5)
                        }
